...
first and last years are typically incomplete (based on datasets from other sources), so I kept this step as a comparison;

<sup>2<sup/>
  
the following years meet this criteria and were INCLUDED: 1999, 2003, 2004, 2006, 2009, 2014;

<sup>3<sup/>

the following years meet this criteria and were INCLUDED: 2003, 2014. No years have more then 15+ datapoints per month, so this is the 'best' datatset regarding monthly coverage.
