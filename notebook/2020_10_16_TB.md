...
HERE IS THE COMPARISON (INCLUDES ALL DATA FOR PRIMARY SOURCE AND SHIP J SHOALS)
    
| Parameter         | primary URI | alternative Ship J Shoals | 
| ------------------| ------------| --------------------------| 
| N_total           |    35031    |        88214              |     
| Mean_daily        |     21.8    |         14.8              |      
| StdDev_daily      |    5.8      |           8.8             |        
| N_years           |    4        |             19            |        
| Mean_yearly_max   |   29.3      |           26.7            |
| StdDeve_yearly_max|    1.0      |           4.9             |
| Mean_yearly_min   |     8.7     |            3.6            |      
| StdDev_yearly_min |     2.0     |             9.2           |
