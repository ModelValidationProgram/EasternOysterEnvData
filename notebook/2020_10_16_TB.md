...
The map below has both NJ populations (unclear from Erin's notes if lat/long for populations are exact or approximate) and for the NOAA datasourc (Ship J Shoal); lat/long for URI data not available.
