...
map: https://www.google.com/maps/d/edit?mid=1ggc_n7JouNgYYtTQXOugT8_ILX3KdCen&ll=37.52139233253085%2C-76.02792199999999&z=9

## Summary tables:

| Parameter             | Temp NERR Flag-filtered | 
| ----------------------| ----------------------- | 
| N_all_datapoints      |        776466           |  
| Mean_all_datapoints   |        16.8             |  
| StdDev_all_datapoints |          8.5            |  
| N_years               |          24             |   
| Mean_yearly_max       |        31.41            |  
| StdDev_yearly_max     |         3.0             | 
| Mean_yearly_min       |          -0.02          |  
| StdDev_yearly_min     |         1.5             | 
| Data range            |  Oct 1997 - Sep 2020    |
| Data frequency        |   every 15 min          |


## Summary notes:

NERR_CBVGIWQ is ok for temperature but not for salinity.

VIMS_Sonde_Marker_119 is ok for salinity
...
* I looked through the EasternOysterSeascapeData spreadsheet version history and it looks like this location's ID was changed by KEL from VA_CB_HC_Med_W to VA_CB_HC_High_W (TB)
