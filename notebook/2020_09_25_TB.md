...
- we'll stick with the VIMS data for salinity, but it puts it in a "high" category whereas previosuly we measured it as medium. CHECK WITH JESS AND DINA ABOUT THIS ONE. DOUBLE CHECK THE MAP.
