...
- The overall data range is 1990-2020 and the 3 datas sources overlap in 2015-2016.
- Data frequency is different for each source: monthly for Hog Island, hourly for Upper Damariscotta and multiple times per month for DockData.
- Many but not all winter months are missing.

- Sal: combine from 2 sources: Hog Island and Upper Damaricotta (all years - KEL notes says 'Hog Island whole years', but I think it's a typo).
- The overall data range is 1990-2019 and the 2 datasources overlap in 2015-2016.
- Data frequency is different for each source: monthly for Hog Island and hourly for Upper Damariscotta.
- Many but not all winter months are missing.
...
## TB and KEL notes
- Separate into 2 separate posts, one for each population
...
- For ME_SR_SM_Low_W
  - Temp - combine Sheepscot all yrs - USGS Sheepscot River all yrs (dock data too far away)
  - Salinity - we decided to use NA because the bouys were not close to the site
